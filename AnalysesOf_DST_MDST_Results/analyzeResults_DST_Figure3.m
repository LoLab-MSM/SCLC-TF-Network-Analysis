...
nets = [res1(:,1:end-1); res2(:,1:end-1); res3(:,1:end-1); res4(:,1:end-1)];
...
for i = 1:m
    ...
    selectedEdges = [SCLCNetEdges(indOfSelectedEdges,:), ones(sum(nets(i,:)),1)];
...
% highlight(p,1:35,'MarkerSize',5)
% highlight(p,6,'MarkerSize',6 + nodeDegrees(6,end))
% highlight(p,14,'MarkerSize',6 + nodeDegrees(14,end))
% highlight(p,1,'MarkerSize',6 + nodeDegrees(1,end))
% highlight(p,7,'MarkerSize',6 + nodeDegrees(7,end))
% highlight(p,19,'MarkerSize',6 + nodeDegrees(19,end))
