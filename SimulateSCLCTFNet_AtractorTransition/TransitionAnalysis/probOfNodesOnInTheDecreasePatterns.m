% Compute probability of nodes being ON in the filtered decrease patterns.
...
for i = 1:numTransit
    ...
    for j = 1:n
        ...
        for p = 1:n2
            counter = counter + 1;
            probNodesON = probNodesON + networkStates(pattern(1,p),:);
        end
...
title('Probability of TFs being ON in the distance decreasing patterns', 'FontSize', 14)
xlim([0, 28])
ax = gca;
set(gca, 'XTick', 1:27)
